...
public class HdrSoftwareRS {
    ...
    public void process() {
        ...
        Allocation row_indices_alloc = 
                Allocation.createSized(mRS, Element.I32(mRS), num_rows, Allocation.USAGE_SCRIPT);
    ...
    public void setBitmapInput(Bitmap input, int input_image) {
        ...
        if (mOutBitmap == null) {
            ...
            // current inputs
            mOutBitmap =
                    Bitmap.createBitmap(input.getWidth(), input.getHeight(), input.getConfig());
        }
    }
}
