...
public class MediaSetUtils {
    ...
    public static int CAMERA_BUCKET_ID(){
        return Storage.getStorage().generateBucketIdInt();
    }
    ...
    public static boolean isCameraSource(Path path) {
        return path.equalsIgnoreCase("/local/all/" + CAMERA_BUCKET_ID())
                || path.equalsIgnoreCase("/local/image/" + CAMERA_BUCKET_ID())
                || path.equalsIgnoreCase("/local/video/" + CAMERA_BUCKET_ID());
    }
